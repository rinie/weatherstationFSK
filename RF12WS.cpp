...
static uint8_t fixedLengthBase;
static uint8_t minLengthCrcOk;
volatile uint8_t rf12_crc8;         // running crc value
...
static uint8_t _crc8_update(uint8_t crc, uint8_t inbyte)
{
		uint8_t i;
		for (i = 8; i; i--) {
